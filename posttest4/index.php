...
<body>
    ...
    <div class="main">
        <p align="center">Vir Café adalah toko kopi unik di pusat kota yang menawarkan beragam biji kopi premium dari seluruh dunia dan peralatan kopi berkualitas tinggi.
            <br> Mereka juga menjadi tempat pertemuan komunitas kopi lokal dan tempat belajar bagi pecinta kopi. 
            <br>Dengan suasana yang hangat dan staf yang berpengetahuan, Vir Cafe adalah surga bagi para penggemar kopi.</p>
        <hr width="1000px">
    ...
    <section id="form">
        <div class="container">
            <form  method="POST" class="custom-form">
                ...
                <!-- Add input fields for Name, Phone Number, and Email -->
